    ...
    <div className={s.wrapper}>
      ...
      <div className={s.info}>
        <p className={s.info__text}>
          ...
          <strong>no more than four words and/or a number</strong> for each
          answer.
        </p>
      </div>
      <ul className={s.list}>
        ...
        <li className={s.link}>
          <p>How long did the author work on cheaken plant?</p>
        </li>

        <li className={s.link}>
          <span>Enter Your answer :</span>
          <AnswerInput
            prop={correctAnswer.fifth}
            check={check}
            setCheck={setCheck}
            clear={clear}
            show={show}
        ...
        <li className={s.link}>
          <p>Did the author lead healthy lifestyle?</p>
        </li>

        <li className={s.link}>
          <span>Enter Your answer :</span>
          <AnswerInput
            prop={correctAnswer.sixth}
            check={check}
            setCheck={setCheck}
            clear={clear}
            show={show}
        ...
        <li className={s.link}>
          <p>Whose biography did the author read?</p>
        </li>
        <li className={s.link}>
          <span>Enter Your answer :</span>
          <AnswerInput
            prop={correctAnswer.seventh}
            check={check}
            setCheck={setCheck}
            clear={clear}
            show={show}
        ...
        <li className={s.link}>
          <p>What is recommended to read?</p>
        </li>

        <li className={s.link}>
          <span>Enter Your answer :</span>
          <AnswerInput
            prop={correctAnswer.eighth}
            check={check}
            setCheck={setCheck}
            clear={clear}
            show={show}
